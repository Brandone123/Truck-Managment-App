...
const { loadingMeasurementUnits: loading } = storeToRefs(commonListStore);

const itemList = computed(() => {
    return commonListStore.getMeasurementUnits
})

onMounted(() => {
    commonListStore.fetchList('measurement-units')
})
