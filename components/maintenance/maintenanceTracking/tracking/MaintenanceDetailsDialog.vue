      ...
      <v-card>
        ...
        <v-card-text>
          <v-table>
            <tbody>
              <tr>
                <td class="text-h6"><strong>Request/Log ID:</strong> {{ log.id }}</td>
          ...
          <v-table>
            <tbody>
              <tr>
                <td><strong>Technician/Vendor</strong></td>
              ...
              <tr>
                <td>{{ log.technician_vendor }}</td>
                <td>{{ log.cost }}</td>
                <td><v-chip :color="getStatusClass(log.status)">{{ log.status }}</v-chip></td>
          ...
          <div class="d-flex">
            ...
            <div class="ml-5 mt-3">{{ log.description }}</div>
          </div>
        </v-card-text>
        <v-divider></v-divider>
        <v-card-actions>
