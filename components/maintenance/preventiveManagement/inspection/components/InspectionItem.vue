            ...
            <div v-if="hasImage && isExpanded" class="ml-10 pa-5">
                ...
                <v-row>
                    <v-col cols="12" md="6" v-for="(img, i) in item.photos" :key="i">
                        <v-card @click="$emit('showImage', i)">
                            <v-img class="mx-auto" :src="img" aspect-ratio="1/1" :alt="img">
