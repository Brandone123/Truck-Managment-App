            ...
            <v-row align="center">
                <v-col cols="6">
                    <div class="d-flex align-center">
                        ...
                        <!-- <v-text-field ref="labelInputRef" v-model="editedItem.label" v-if="isEditingLabel"
                            ...
                            variant="outlined" density="compact" label="Enter Inspection Item Label"
                        ...
                        <span v-else style="height:40px" class="d-flex align-center">
                            ...
                            <v-btn class="ml-3" density="comfortable" variant="text" icon="mdi-pencil-outline"
                                size="small" @click="showLabelInput"></v-btn> </span>-->
                ...
                <v-col>
                    <div class="d-flex justify-end align-center">
                        <v-chip class="mr-2">
                            <v-icon color="grey">mdi-calendar-minus</v-icon>Date / Time
                        </v-chip>
        ...
        <v-expand-transition>
            <v-card-text v-if="isExpanded" class="pl-9">
                <v-row>
                    ...
                    <v-col cols="12" class="py-0">
                        <v-radio-group column v-model="editedItem.date_only">
                            <v-radio color="red" label="Date Only" :value="true"></v-radio>
                            <v-radio color="indigo-darken-3" label="Date and Time" :value="false"></v-radio>
                        </v-radio-group>
                    </v-col>
                </v-row>
            </v-card-text>
