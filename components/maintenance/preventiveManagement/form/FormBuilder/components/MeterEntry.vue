            ...
            <v-row align="center">
                ...
                <v-col>
                    <div class="d-flex justify-end align-center">
                        <v-chip class="mr-2">
                            <v-icon color="grey">mdi-gauge</v-icon>Meter Entry
                        </v-chip>
        ...
        <v-expand-transition>
            <v-card-text v-if="isExpanded" class="pl-9">
                <v-row>
                    ...
                    <v-col cols="12" class="py-0">
                        <v-checkbox v-model="editedItem.require_secondary_meter" hide-details
                            label="Require Secondary Meter" color="primary"></v-checkbox>
                    </v-col>
                    <v-col cols="12" class="py-0">
                        <v-checkbox v-model="editedItem.require_photo_verification" hide-details
                            label="Require Photo Verification" color="primary"></v-checkbox>
                    </v-col>
                </v-row>
            </v-card-text>
        </v-expand-transition>
...
interface MeterEntry {
    ...
    required: boolean
    description: string
    require_secondary_meter: boolean
...
const props = defineProps({
    modelValue: {
        type: Object as PropType<MeterEntry>,
        required: true,
        default: {} as MeterEntry
    },
    expanded: {
        type: Boolean,
        default: true,
...
const editedItem = ref<MeterEntry>(props.modelValue)
