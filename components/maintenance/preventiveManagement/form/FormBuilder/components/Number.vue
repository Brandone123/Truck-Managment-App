    ...
    <v-card @mouseover="isHovering = true" @mouseout="isHovering = false">
            ...
            <v-row align="center">
                ...
                <v-col>
                    <div class="d-flex justify-end align-center">
                        <v-chip class="mr-2">
                            <v-icon color="grey">mdi-pound</v-icon> Number
                        </v-chip>
        ...
        <v-expand-transition>
            <v-card-text v-if="isExpanded" class="pl-9">
                ...
                <p class="mt-8 mb-4 text-body-1 ">Passing Range</p>
                <v-row>
                    <v-col cols="12" md="3" class="pt-0">
                        <v-text-field v-model="editedItem.minimum_pass_range" hide-details variant="outlined"
                            density="compact" label="Minimum" placeholder="No Minimum" type="number"></v-text-field>
                    </v-col>
                    <v-col cols="12" md="3" class="pt-0">
                        <v-text-field v-model="editedItem.maximum_pass_range" hide-details variant="outlined"
                            density="compact" label="Maximum" placeholder="No Maximum" type="number"></v-text-field>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="12" class="pb-0">
                        <v-checkbox v-model="editedItem.required" hide-details
...
interface NumberType {
    ...
    description: string
    instructions: string
    minimum_pass_range: string
    maximum_pass_range: string
...
const editedItem = ref<NumberType>(props.modelValue)
