                        ...
                        <v-col cols="12" class="pb-0">
                            <v-row>
                                ...
                                <v-col cols="12" md="3" class="pb-0">
                                    <v-text-field v-model="stopInfo.city" variant="solo" flat label="City" density="compact"></v-text-field>
                                </v-col>
                                <v-col cols="12" md="3" class="pb-0">
                                    <v-select v-model="stopInfo.state" variant="solo" flat :items="['state 1', 'state 2']"  label="State"
                                        density="compact"></v-select>
                                </v-col>
                                <v-col cols="12" md="3" class="pb-0">
                                    <v-text-field v-model="stopInfo.zip" variant="solo" flat label="Zip" type="number"
                                        density="compact"></v-text-field>
                                </v-col>
                                <v-col cols="12" md="3" class="pb-0">
                                    <v-select v-model="stopInfo.zone" variant="solo" flat :items="zoneList" item-title="code" item-value="id"
