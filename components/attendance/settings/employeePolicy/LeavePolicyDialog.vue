        ...
        <v-form ref="employeePolicyForm">
          <v-row class="my-4">
            <v-col cols="12" class="pb-0">
              <v-autocomplete v-model="employeePolicyInfo.leave_policy_id" :items="leavePolicyList" variant="solo" flat
...
const save = () => {
  employeeStore.updateEmployee({
    id: employeePolicyInfo.value.id,
    leave_policy_id: employeePolicyInfo.value.leave_policy_id,
  });
  dialog.value = false;
};
